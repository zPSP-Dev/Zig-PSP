...
ld.lld -L../psp/lib -T../psp/lib/linkfile.ld -lpsp -lc ../psp/lib/modulestart.o moduleinfo.o ../psp/lib/prxexports.o main.o -o a.elf -emit-relocs --eh-frame-hdr --no-gc-sections
