...
pub extern fn sceHprmPeekCurrentKey(key: [*c]u32_3) c_int;
pub extern fn sceHprmPeekLatch(latch: [*c]u32_3) c_int;
pub extern fn sceHprmReadLatch(latch: [*c]u32_3) c_int;
