...
pub extern fn sceKernelUtilsMt19937Init(ctx: [*c]SceKernelUtilsMt19937Context, seed: u32_3) c_int;
pub extern fn sceKernelUtilsMt19937UInt(ctx: [*c]SceKernelUtilsMt19937Context) u32_3;
...
pub extern fn sceKernelUtilsMd5Digest(data: [*c]u8_1, size: u32_3, digest: [*c]u8_1) c_int;
pub extern fn sceKernelUtilsMd5BlockInit(ctx: [*c]SceKernelUtilsMd5Context) c_int;
pub extern fn sceKernelUtilsMd5BlockUpdate(ctx: [*c]SceKernelUtilsMd5Context, data: [*c]u8_1, size: u32_3) c_int;
pub extern fn sceKernelUtilsMd5BlockResult(ctx: [*c]SceKernelUtilsMd5Context, digest: [*c]u8_1) c_int;
...
pub extern fn sceKernelUtilsSha1Digest(data: [*c]u8_1, size: u32_3, digest: [*c]u8_1) c_int;
pub extern fn sceKernelUtilsSha1BlockInit(ctx: [*c]SceKernelUtilsSha1Context) c_int;
pub extern fn sceKernelUtilsSha1BlockUpdate(ctx: [*c]SceKernelUtilsSha1Context, data: [*c]u8_1, size: u32_3) c_int;
pub extern fn sceKernelUtilsSha1BlockResult(ctx: [*c]SceKernelUtilsSha1Context, digest: [*c]u8_1) c_int;
