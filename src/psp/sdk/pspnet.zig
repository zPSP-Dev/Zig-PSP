...
pub extern fn sceNetAdhocPdpSend(id: c_int, destMacAddr: [*c]u8, port: c_ushort, data: ?*anyopaque, len: c_uint, timeout: c_uint, nonblock: c_int) c_int;
pub extern fn sceNetAdhocPdpRecv(id: c_int, srcMacAddr: [*c]u8, port: [*c]c_ushort, data: ?*anyopaque, dataLength: ?*anyopaque, timeout: c_uint, nonblock: c_int) c_int;
...
pub extern fn sceNetAdhocGameModeCreateMaster(data: ?*anyopaque, size: c_int) c_int;
pub extern fn sceNetAdhocGameModeCreateReplica(mac: [*c]u8, data: ?*anyopaque, size: c_int) c_int;
...
pub extern fn sceNetAdhocPtpSend(id: c_int, data: ?*anyopaque, datasize: [*c]c_int, timeout: c_uint, nonblock: c_int) c_int;
pub extern fn sceNetAdhocPtpRecv(id: c_int, data: ?*anyopaque, datasize: [*c]c_int, timeout: c_uint, nonblock: c_int) c_int;
...
pub const sceNetAdhocctlHandler = ?fn (c_int, c_int, ?*anyopaque) callconv(.C) void;
...
pub const pspAdhocMatchingCallback = ?fn (c_int, c_int, [*c]u8, c_int, ?*anyopaque) callconv(.C) void;
...
pub extern fn sceNetAdhocMatchingSelectTarget(matchingid: c_int, mac: [*c]u8, optlen: c_int, optdata: ?*anyopaque) c_int;
pub extern fn sceNetAdhocMatchingCancelTarget(matchingid: c_int, mac: [*c]u8) c_int;
pub extern fn sceNetAdhocMatchingCancelTargetWithOpt(matchingid: c_int, mac: [*c]u8, optlen: c_int, optdata: ?*anyopaque) c_int;
pub extern fn sceNetAdhocMatchingSendData(matchingid: c_int, mac: [*c]u8, datalen: c_int, data: ?*anyopaque) c_int;
pub extern fn sceNetAdhocMatchingAbortSendData(matchingid: c_int, mac: [*c]u8) c_int;
pub extern fn sceNetAdhocMatchingSetHelloOpt(matchingid: c_int, optlen: c_int, optdata: ?*anyopaque) c_int;
pub extern fn sceNetAdhocMatchingGetHelloOpt(matchingid: c_int, optlen: [*c]c_int, optdata: ?*anyopaque) c_int;
pub extern fn sceNetAdhocMatchingGetMembers(matchingid: c_int, length: [*c]c_int, buf: ?*anyopaque) c_int;
...
pub const sceNetApctlHandler = ?fn (c_int, c_int, c_int, c_int, ?*anyopaque) callconv(.C) void;
...
pub extern fn sceNetApctlAddHandler(handler: sceNetApctlHandler, pArg: ?*anyopaque) c_int;
...
pub const ApctlEvent = enum(c_int) {
    ConnectRequest,
    ScanRequest,
    ScanComplete,
    Established,
...
pub const ApctlInfo = enum(c_int) {
    ProfileName,
    Bssid,
    Ssid,
    SsidLength,
...
pub const ApctlInfoSecurityType = enum(c_int) {
    None,
    Wep,
    Wpa,
};
