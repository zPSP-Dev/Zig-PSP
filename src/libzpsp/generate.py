...
def parse_c_type_to_zig(c_type: str) -> str:
    ...
    type_map = {
        ...
        "SceSSize": "types.SceSSize",
        "SceUChar": "types.SceUChar",
        "SceUInt": "types.SceUInt",
        "SceMode": "types.SceMode",
        "SceOff": "types.SceOff",
        "SceIores": "types.SceIores",
        "SceUChar8": "types.SceUChar8",
        "SceUShort16": "types.SceUShort16",
        "SceUInt32": "types.SceUInt32",
        "SceUInt64": "types.SceUInt64",
        "SceULong64": "types.SceULong64",
        "SceChar8": "types.SceChar8",
        "SceShort16": "types.SceShort16",
        "SceInt32": "types.SceInt32",
        "SceInt64": "types.SceInt64",
        "SceLong64": "types.SceLong64",
        "SceFloat": "types.SceFloat",
        "SceFloat32": "types.SceFloat32",
        "SceWChar16": "types.SceWChar16",
        "SceWChar32": "types.SceWChar32",
