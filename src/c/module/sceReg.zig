...
pub extern fn sceRegOpenRegistry(reg: [*c]types.RegParam, mode: c_int, h: [*c]types.REGHANDLE) callconv(.c) c_int;

/// Close the registry
/// `h` - The open registry handle
/// Returns 0 on success, < 0 on error
pub extern fn sceRegCloseRegistry(h: types.REGHANDLE) callconv(.c) c_int;

/// Remove a registry (HONESTLY, DO NOT USE)
/// `reg` - Filled out registry parameter
/// Returns 0 on success, < 0 on error
pub extern fn sceRegRemoveRegistry(reg: [*c]types.RegParam) callconv(.c) c_int;
...
/// Returns 0 on success, < 0 on error
pub extern fn sceRegOpenCategory(h: types.REGHANDLE, name: [*c]const c_char, mode: c_int, hd: [*c]types.REGHANDLE) callconv(.c) c_int;

/// Close the registry directory
/// `hd` - The open registry dir handle
/// Returns 0 on success, < 0 on error
pub extern fn sceRegCloseCategory(hd: types.REGHANDLE) callconv(.c) c_int;

/// Flush the registry to disk
/// `h` - The open registry handle
/// Returns 0 on success, < 0 on error
pub extern fn sceRegFlushRegistry(h: types.REGHANDLE) callconv(.c) c_int;

/// Flush the registry directory to disk
/// `hd` - The open registry dir handle
/// Returns 0 on success, < 0 on error
pub extern fn sceRegFlushCategory(hd: types.REGHANDLE) callconv(.c) c_int;
...
/// Returns 0 on success, < 0 on error
pub extern fn sceRegGetKeysNum(hd: types.REGHANDLE, num: [*c]c_int) callconv(.c) c_int;
...
/// `num` - Pointer to an integer to receive the number
/// Returns 0 on success, < 0 on error
pub extern fn sceRegGetKeys(hd: types.REGHANDLE, buf: [*c]c_char, num: c_int) callconv(.c) c_int;

/// Remove a registry dir
/// `h` - The open registry dir handle
/// `name` - The name of the key
/// Returns 0 on success, < 0 on error
pub extern fn sceRegRemoveCategory(h: types.REGHANDLE, name: [*c]const c_char) callconv(.c) c_int;
