...
pub extern fn sceKernelMaxFreeMemSize() callconv(.c) usize;

/// Get the total amount of free memory.
/// Returns The total amount of free memory, in bytes.
pub extern fn sceKernelTotalFreeMemSize() callconv(.c) usize;
...
pub extern fn sceKernelAllocPartitionMemory(partitionid: types.SceUID, name: [*c]const c_char, type: c_int, size: usize, addr: ?*anyopaque) callconv(.c) types.SceUID;
