...
pub extern fn sceNetAdhocMatchingGetPoolStat(poolstat: [*c]pspAdhocPoolStat) c_int;
pub extern fn sceNetApctlInit(stackSize: c_int, initPriority: c_int) c_int;
pub extern fn sceNetApctlTerm() c_int;
pub extern fn sceNetApctlGetInfo(code: c_int, pInfo: [*c]SceNetApctlInfo) c_int;
