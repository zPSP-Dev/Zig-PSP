...
pub fn main(init: std.process.Init) !void {
    ...
    sdk.extra.debug.print("[12] Renamed hello.txt -> greeting.txt\n", .{});

    // [13] dirAccess
    try cwd.access(io, "ms0:/psp_test/greeting.txt", .{});
    sdk.extra.debug.print("[13] dirAccess greeting.txt: ok\n", .{});

    // [14] Delete file
    try cwd.deleteFile(io, "ms0:/psp_test/greeting.txt");
    sdk.extra.debug.print("[14] Deleted file: greeting.txt\n", .{});
    ...
    sdk.extra.debug.print("[15] Deleted dirs\n", .{});
